...
#define Left_LED_Blue_DM_ALG_HIZ         (0x00u)
#define Left_LED_Blue_DM_DIG_HIZ         (0x01u)
#define Left_LED_Blue_DM_RES_UP          (0x02u)
#define Left_LED_Blue_DM_RES_DWN         (0x03u)
#define Left_LED_Blue_DM_OD_LO           (0x04u)
#define Left_LED_Blue_DM_OD_HI           (0x05u)
#define Left_LED_Blue_DM_STRONG          (0x06u)
#define Left_LED_Blue_DM_RES_UPDWN       (0x07u)
...
#if defined(Left_LED_Blue__INTSTAT)  /* Interrupt Registers */
