...
#define TCPWM_TC_COUNTER_MODE                (1lu)
#define TCPWM_TC_COMP_CAP_MODE               (0lu)
...
#define TCPWM_PWM_MODE_CENTER                (TCPWM_CC_MATCH_INVERT       |   \
                                                         TCPWM_OVERLOW_NO_CHANGE     |   \
                                                         TCPWM_UNDERFLOW_CLEAR)
#define TCPWM_PWM_MODE_ASYM                  (TCPWM_CC_MATCH_NO_CHANGE    |   \
                                                         TCPWM_OVERLOW_SET           |   \
                                                         TCPWM_UNDERFLOW_CLEAR )
