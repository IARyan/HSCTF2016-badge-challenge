...
void PWM_Timer_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG16(PWM_Timer_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint16 PWM_Timer_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG16(PWM_Timer_CAPTURE_LSB_PTR));
    }
...
void PWM_Timer_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(PWM_Timer_PERIOD_LSB_PTR, period);
    #endif /* (PWM_Timer_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG16(PWM_Timer_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_Timer_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG16(PWM_Timer_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_Timer_UsingFixedFunction) */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_Timer_UsingFixedFunction)
            return ((uint16)CY_GET_REG16(PWM_Timer_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG16(PWM_Timer_COMPARE1_LSB_PTR));
        #endif /* (PWM_Timer_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG16(PWM_Timer_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_Timer_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(PWM_Timer_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG16(PWM_Timer_PERIOD_LSB_PTR));
    #endif /* (PWM_Timer_UsingFixedFunction) */
}
