...
void LCD_Char_IsReady(void) 
{
    ...
    /* Clear LCD port*/
    LCD_Char_PORT_DR_REG &= ((uint32)(~LCD_Char_PORT_MASK));
    ...
    */
    ...
    /* Make sure RS is low */
    LCD_Char_PORT_DR_REG &= ((uint32)(~LCD_Char_RS));
    ...
    do
    {
        ...
        /* Set enable low */
        LCD_Char_PORT_DR_REG &= ((uint32)(~LCD_Char_E));
    ...
    LCD_Char_PORT_DR_REG &= ((uint32)(~LCD_Char_RW));
...
static void LCD_Char_WrDatNib(uint8 nibble) 
{
    ...
    /* Clear data pins */
    LCD_Char_PORT_DR_REG &= ((uint32)(~LCD_Char_DATA_MASK));
...
static void LCD_Char_WrCntrlNib(uint8 nibble) 
{
    ...
    LCD_Char_PORT_DR_REG &= ((uint32)(~(LCD_Char_RS | LCD_Char_RW)));
