...
/* Device specific registers */
    ...
    #define LCD_Char_PORT_DR_REG           (*(reg32 *) LCD_Char_LCDPort__DR)  /* Data Output Register */
    #define LCD_Char_PORT_DR_PTR           ( (reg32 *) LCD_Char_LCDPort__DR)
    #define LCD_Char_PORT_PS_REG           (*(reg32 *) LCD_Char_LCDPort__PS)  /* Pin State Register */
    #define LCD_Char_PORT_PS_PTR           ( (reg32 *) LCD_Char_LCDPort__PS)
    
    #define LCD_Char_PORT_PC_REG           (*(reg32 *) LCD_Char_LCDPort__PC)
    #define LCD_Char_PORT_PC_PTR           (*(reg32 *) LCD_Char_LCDPort__PC)
    
#else

    #define LCD_Char_PORT_DR_REG           (*(reg8 *) LCD_Char_LCDPort__DR)  /* Data Output Register */
    #define LCD_Char_PORT_DR_PTR           ( (reg8 *) LCD_Char_LCDPort__DR)
    #define LCD_Char_PORT_PS_REG           (*(reg8 *) LCD_Char_LCDPort__PS)  /* Pin State Register */
    #define LCD_Char_PORT_PS_PTR           ( (reg8 *) LCD_Char_LCDPort__PS)

    #define LCD_Char_PORT_DM0_REG          (*(reg8 *) LCD_Char_LCDPort__DM0) /* Port Drive Mode 0 */
    #define LCD_Char_PORT_DM0_PTR          ( (reg8 *) LCD_Char_LCDPort__DM0)
    #define LCD_Char_PORT_DM1_REG          (*(reg8 *) LCD_Char_LCDPort__DM1) /* Port Drive Mode 1 */
    #define LCD_Char_PORT_DM1_PTR          ( (reg8 *) LCD_Char_LCDPort__DM1)
    #define LCD_Char_PORT_DM2_REG          (*(reg8 *) LCD_Char_LCDPort__DM2) /* Port Drive Mode 2 */
    #define LCD_Char_PORT_DM2_PTR          ( (reg8 *) LCD_Char_LCDPort__DM2)
...
#if (0 == LCD_Char_LCDPort__SHIFT)
    #define LCD_Char_PORT_SHIFT               (0x00u)
#else
    #define LCD_Char_PORT_SHIFT               (0x01u)
#endif /* (0 == LCD_Char_LCDPort__SHIFT) */

#define LCD_Char_PORT_MASK                ((uint32) (LCD_Char_LCDPort__MASK))

#if (CY_PSOC4)

    #define LCD_Char_DM_PIN_STEP              (3u)
    ...
    */
    #define LCD_Char_HIGH_Z_DATA_DM           ((0x00000249ul) << (LCD_Char_PORT_SHIFT *\
                                                                          LCD_Char_DM_PIN_STEP))
    #define LCD_Char_STRONG_DATA_DM           ((0x00000DB6ul) << (LCD_Char_PORT_SHIFT *\
                                                                          LCD_Char_DM_PIN_STEP))
    #define LCD_Char_DATA_PINS_MASK           (0x00000FFFul)
    #define LCD_Char_DM_DATA_MASK             ((uint32) (LCD_Char_DATA_PINS_MASK << \
                                                      (LCD_Char_PORT_SHIFT * LCD_Char_DM_PIN_STEP)))

#else

    /* Drive Mode register values for High Z */
    #define LCD_Char_HIGH_Z_DM0               (0xFFu)
    #define LCD_Char_HIGH_Z_DM1               (0x00u)
    #define LCD_Char_HIGH_Z_DM2               (0x00u)

    /* Drive Mode register values for High Z Analog */
    #define LCD_Char_HIGH_Z_A_DM0             (0x00u)
    #define LCD_Char_HIGH_Z_A_DM1             (0x00u)
    #define LCD_Char_HIGH_Z_A_DM2             (0x00u)

    /* Drive Mode register values for Strong */
    #define LCD_Char_STRONG_DM0               (0x00u)
    #define LCD_Char_STRONG_DM1               (0xFFu)
    #define LCD_Char_STRONG_DM2               (0xFFu)

#endif /* CY_PSOC4 */

/* Pin Masks */
#define LCD_Char_RS                     ((uint32) \
                                                (((uint32) 0x20u) << LCD_Char_LCDPort__SHIFT))
#define LCD_Char_RW                     ((uint32) \
                                                (((uint32) 0x40u) << LCD_Char_LCDPort__SHIFT))
#define LCD_Char_E                      ((uint32) \
                                                (((uint32) 0x10u) << LCD_Char_LCDPort__SHIFT))
#define LCD_Char_READY_BIT              ((uint32) \
                                                (((uint32) 0x08u) << LCD_Char_LCDPort__SHIFT))
#define LCD_Char_DATA_MASK              ((uint32) \
                                                (((uint32) 0x0Fu) << LCD_Char_LCDPort__SHIFT))

/* These names are obsolete and will be removed in future revisions */
#define LCD_Char_PORT_DR                  LCD_Char_PORT_DR_REG
#define LCD_Char_PORT_PS                  LCD_Char_PORT_PS_REG
#define LCD_Char_PORT_DM0                 LCD_Char_PORT_DM0_REG
#define LCD_Char_PORT_DM1                 LCD_Char_PORT_DM1_REG
#define LCD_Char_PORT_DM2                 LCD_Char_PORT_DM2_REG
